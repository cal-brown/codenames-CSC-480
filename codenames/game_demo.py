...
class Game:
    ...
    def __init__(self, red_codemaster, red_guesser, blue_codemaster, blue_guesser,
        ...
        self.red_codemaster = red_codemaster("Red",**cm_kwargs)
        self.red_guesser = red_guesser()
        self.blue_codemaster = blue_codemaster("Blue",**cm_kwargs)
    ...
    def run(self):
        ...
        while game_condition != GameCondition.LOSS and game_condition != GameCondition.WIN:
            ...
            self.red_codemaster.set_game_state(words_in_play, current_key_grid)
            self.blue_codemaster.set_game_state(words_in_play, current_key_grid)
